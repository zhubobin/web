...
class Api_Test extends Api_Common {
	...
	public function getRules() {
		return array(
			...
			'getUserInfo' => array(
				'uid' => array('name' => 'uid', 'type' => 'int', 'min' => 1, 'require' => true),	'token' => array('name' => 'token', 'type' => 'string', 'require' => true, 'desc' => '用户token'),		
			),
	...
	public function getUserInfo(){
		$re['data'] 	=	100;
		$re['msg'] 		=	'this is get user info function';
		$user 			=	new Domain_User();
		$checkToken=$this->checkToken($this->uid,$this->token);
		echo $checkToken;die;
		var_dump($user->getBaseInfo($this->uid));
	...
	public function getRechargeInfo(){
		...
		$rs['info'] = array(array('cuckoo'=>60,'money'=>6),array('cuckoo'=>300,'money'=>30),array('cuckoo'=>980,'money'=>98),array('cuckoo'=>2980,'money'=>298),array('cuckoo'=>5880,'money'=>588),array('cuckoo'=>15980,'money'=>1598));
		return $rs;
	}
