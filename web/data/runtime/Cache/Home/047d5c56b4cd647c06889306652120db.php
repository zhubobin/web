...
<head>
	...
	<![endif]-->
	<link rel="icon" href="/web/public/images/favicon.ico" type="image/x-icon">
	<link rel="shortcut icon" href="/web/public/images/favicon.ico" type="image/x-icon">
	
	<link type="text/css" rel="stylesheet" href="/web/public/home/css/common.css"/>
	<link type="text/css" rel="stylesheet" href="/web/public/home/css/login.css"/>
	<link type="text/css" rel="stylesheet" href="/web/public/home/css/layer.css"/>
	...
	<meta name="description" content="<?php echo ($site_seo_description); ?>"/>
	  ...
	  <script>
		...
		<!-- 环信私信功能start -->
		<!--sdk-->
		<script src="/web/public/home/hxChat/js/strophe.js"></script>
		<script src="/web/public/home/hxChat/js/easemob.im-1.1.1.js"></script>
		<script src="/web/public/home/hxChat/js/easemob.im.shim.js"></script><!--兼容老版本(1.0.7含以前版本)sdk需引入此文件-->

		<!--config-->
		<script src="/web/public/home/hxChat/js/easemob.im.config.js"></script>

		<!--demo-->
		<script src="/web/public/home/hxChat/js/jquery-1.11.1.js"></script><!--此非jquery原生库，已经做过修改，环信功能必须调用-->
		<script src="/web/public/home/hxChat/js/bootstrap.js"></script>
		<link rel="stylesheet" href="/web/public/home/hxChat/css/webim.css" />

		<script type="text/javascript" src="/web/public/home/hxChat/js/webim.js"></script>

		<!-- 环信私信功能end -->
<title><?php echo ($site_name); ?></title>
<link type="text/css" rel="stylesheet" href="/web/public/home/css/index.css"/>
...
-->
		...
		<div class="container clearfix">
			<div class="main clearfix">
				<div id="focuspic" class="focuspic feed-list">
					<ul class="list">
						<?php if(is_array($recommend)): $i = 0; $__LIST__ = $recommend;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i; if($i == '1'): ?><li class="special live feed"><a class="link clearfix" target="_blank" href="./<?php echo ($v['uid']); ?>">
							<img class="screenshot thumb" src="/web/public/home/images/lazyload.png" data-original="<?php echo ($v['thumb']); ?>"/>
							<p class="user">
								<span class="username"><?php echo ($v['user_nicename']); ?></span><span class="watches"><span class="sub"><?php echo ($v['nums']); ?></span></span>
							</p>
							</a></li>
						 <?php else: ?>
							 <li class="normal  <?php if($v['islive'] == '1'): ?>live<?php else: endif; ?> feed"><a class="link clearfix" target="_blank" href="./<?php echo ($v['uid']); ?>"><img class="screenshot thumb" src="/web/public/home/images/lazyload.png" data-original="<?php echo ($v['thumb']); ?>"/>
								<p class="user">
									<span class="username"><?php echo ($v['user_nicename']); ?></span><span class="watches"><span class="sub"><?php echo ($v['nums']); ?></span></span>
								</p>
				...
				<div class="g-box feed-list" id="hot">
					...
					<div class="box-bd">
						<ul class="list">
						  <?php if(is_array($hot)): $i = 0; $__LIST__ = $hot;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="feed <?php if($v['islive'] == '1'): ?>live<?php else: endif; ?> "><a class="link" href="./<?php echo ($v['uid']); ?>" target="_blank"><img class="screenshot thumb" src="/web/public/home/images/lazyload.png" data-original="<?php echo ($v['thumb']); ?>"/>
							<p class="user">
								<img class="avatar thumb" src="/web/public/home/images/lazyload.png" data-original="<?php echo ($v['avatar']); ?>"/><span class="username"><?php echo ($v['user_nicename']); ?></span>
							</p>
							<div class="comment">
				...
				<div class="g-box feed-list" id="living">
					...
					<div class="box-bd">
						<ul class="list">
						  <?php if(is_array($live)): $i = 0; $__LIST__ = $live;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="feed <?php if($v['islive'] == '1'): ?>live<?php else: endif; ?>"><a class="link" href="./<?php echo ($v['uid']); ?>" target="_blank"><img class="screenshot thumb" src="/web/public/home/images/lazyload.png" data-original="<?php echo ($v['thumb']); ?>"/>
							<p class="user">
								<img class="avatar thumb" src="/web/public/home/images/lazyload.png" data-original="<?php echo ($v['avatar']); ?>"/><span class="username"><?php echo ($v['user_nicename']); ?></span>
							</p>
							<div class="comment">
	...
	<div id="doc-ft">
	 ...
	 <!--  <script src="/web/public/home/js/jquery.1.10.2.js"></script>  -->
...
<!-- 	  <script src="/web/public/home/js/jquery.lazyload.min.js"></script> -->
		<script type="text/javascript">
			window._DATA = window._DATA || {};
			window._DATA.user = <?php echo ($userinfo); ?>;
		</script> 
		<script type="text/javascript" src="/web/public/home/js/login.js"></script> 
		<script type="text/javascript" src="/web/public/home/js/layer.js"></script> 
