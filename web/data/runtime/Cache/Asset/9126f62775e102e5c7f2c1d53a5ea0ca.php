...
.eidt_uphoto .no {
    background: url("/web/admin/themes/simplebootx/Public/assets/images/upload_pic.jpg") no-repeat scroll center center #FBFBFB;
    border: 1px solid #CCCCCC;
    height: 98px;
    overflow: hidden;
    text-indent: -2000em;
...
.eidt_uphoto .del{
	...
	width:15px;
	height:15px;
	background:url("/web/admin/themes/simplebootx/Public/assets/images/upload_del.png") no-repeat;
	right:1px;
	top:1px;
	overflow:hidden;
	text-indent:-2000em;
...
/*上传选择按钮*/
#btupload,.addnew{
	background: url("/web/public/js/swfupload/images/swfBnt.png") no-repeat; float:left; margin-right:10px;width:75px; height:28px; line-height:28px;font-weight:700; color:#fff;
}
#btupload{ 
...
var swfu = '';
	$(document).ready(function(){
		Wind.use("swfupload",GV.DIMAUB+"public/js/swfupload/handlers.js",function(){
		      swfu = new SWFUpload({
			flash_url:"/web/public/js/swfupload/swfupload.swf",
			upload_url:"<?php echo U('assetcut/swfupload');?>",
			...
			post_params:{
			                        ...
			                        "thumb_height":"0",
			                        "watermark_enable":"1",
			                        "filetype_post":"jpg|jpeg|gif|png|bmp|zip|swf"
			},
			file_size_limit:"20240KB",
			file_types:"*.jpg;*.jpeg;*.gif;*.png;*.bmp;*.zip;*.swf",
