...
<body>
	<div class="wrap js-check-wrap">
		...
		<form class="form-horizontal js-ajax-forms" action="<?php echo U('indexadmin/edit_post');?>" method="post">
			<fieldset>
			   <input type="hidden" name="id" value="<?php echo ($userinfo['id']); ?>" id="id"/>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="experience" value="<?php echo ($userinfo['experience']); ?>" id="experience"/>
						<span class="form-required">*</span>
					</div>
				</div>
		<!-- 		<div class="control-group">
			...
			<div class="form-actions">
				...
				<a class="btn" href="javascript:history.go(-1);"><?php echo L('BACK');?></a>
			</div>
		</form>
	</div>
