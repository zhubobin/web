...
.nav li:hover
{
	...
	<div class="wrap js-check-wrap">
		...
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('TiXian/set_post');?>">
				...
				<div>
					<fieldset>						
						<div class="control-group">
							...
							<div class="controls">				
								<input type="text" name="post[fee]" value="<?php echo ($config['fee']); ?>">元
							</div>
						</div>
					</fieldset>
				</div>
			...
			<div class="form-actions">
				...
				<a class="btn" href="<?php echo U('tixian/index');?>"><?php echo L('BACK');?></a>
			</div>
		</form>
	</div>
