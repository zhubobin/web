...
.nav li:hover
{
	...
	<div class="wrap js-check-wrap">
		...
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Exguize/set_post');?>">
				...
				<div>
					<fieldset>						
						<div class="control-group">
							...
							<div class="controls">				
								<input type="text" name="post[exchange_rate]" value="<?php echo ($config['exchange_rate']); ?>">%
							</div>
						</div>
					</fieldset>
				</div>
			...
			<div class="form-actions">
				...
				<a class="btn" href="<?php echo U('exguize/index');?>"><?php echo L('BACK');?></a>
			</div>
		</form>
	</div>
