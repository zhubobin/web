					...
					<?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
					   <td><input name="listorders[<?php echo ($vo['id']); ?>]" type="text" size="3" value="<?php echo ($vo['orderno']); ?>" class="input input-order"></td>
						...
						<td align="center">	
							...
							<?php if(in_array($vo['id'],array('9','19','21','22') )): else: ?>
							 |
							  <a href="<?php echo U('Gift/del',array('id'=>$vo['id']));?>" class="js-ajax-dialog-btn" data-msg="您确定要删除吗？">删除</a><?php endif; ?>
						</td>
